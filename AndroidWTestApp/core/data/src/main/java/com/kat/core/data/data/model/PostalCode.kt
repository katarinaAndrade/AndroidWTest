package com.kat.core.data.data.model
...
data class PostalCode(
    ...
    @ColumnInfo(name = "prep1") val prep1: String?,
    @ColumnInfo(name = "titulo_arteria") val tituloArteria: String?,
    @ColumnInfo(name = "prep2") val prep2: String?,
    ...
    @ColumnInfo(name = "ext_cod_postal") val extCodPostal: String?,
